const Footer: React.FC = () => {
    ...
    return (
        <footer className="mt-auto bg-gray-400 border-t border-gray-300 text-white/95 text-xs md:text-sm py-2 px-4 flex flex-col md:flex-row items-center justify-between gap-1 shadow-inner">
